    ...
    public partial class Form1 : Form
    {
        ...
        private void ProcessView()
        {
            try
            {
                ...
                foreach(var proc in Process.GetProcesses())
                {
                    ...
                    var strArray = new string[] {proc.ProcessName.ToString(),
                    proc.Id.ToString(), str[0], NumFormat(proc.WorkingSet64)};
        ...
        private void ProcessKill()
        {
            try
            {
                ...
                if(!(tProcess == null))
                {
                    var dir = MessageBox.Show(this.lvView.SelectedItems[0].SubItems[0].Text + "프로세스를 끝내시겠습니까?",
                        "알림",
                ...
                {
                    MessageBox.Show(this.lvView.SelectedItems[0].SubItems[0].Text + "프로세스는 존재하지 않습니다.", "알림",
